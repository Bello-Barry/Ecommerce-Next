          ...
          <div className="p-6 sm:p-12">
              ...
              {pageLevelLoader ? (
                ...
                <div className="mt-4 flex flex-col gap-4">
                  {addresses && addresses.length ? (
                    ...
                    <p>Pas d’adresse trouvée ! Veuillez ajouter une nouvelle adresse ci-dessous</p>
                  )}
                </div>
              )}
            </div>
            <div className="mt-4">
              <button
                ...
                className="mt-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
              >
                {showAddressForm ? "Masquer le formulaire d’adresse" : "Ajouter une nouvelle adresse"}
              </button>
            </div>
            {showAddressForm ? (
