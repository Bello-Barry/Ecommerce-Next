          ...
          <div className="mx-auto mt-8 max-w-screen-xl px-4 sm:px-6 lg:px-8 ">
            <div className="bg-white shadow">
              <div className="px-4 py-6 sm:px-8 sm:py-10 flex flex-col gap-5">
                ...
                Votre paiement a réussi et vous serez redirigé vers
                  page de commandes en 2 secondes !
                </h1>
              </div>
            </div>
          </div>
    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          <p className="font-medium text-xl">Résumé du panier</p>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          <p className="text-xl font-medium">Détails de l’adresse de livraison</p>
          <p className="text-gray-400 font-bold">
          Complétez votre commande en sélectionnant l’adresse ci-dessous
          </p>
          ...
          <div className="mt-6 border-t border-b py-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="text-lg font-bold text-gray-900">gratuit
</p>
            </div>
            <div className="flex items-center justify-between">
